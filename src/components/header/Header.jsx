    ...
    <header className="relative bg-capi_purple min-h-64 py-10 px-4 text-white">
      ...
      <div className="container flex flex-col items-center justify-center mx-auto max-w-4xl">
        <div className="flex items-center justify-center ">
          <h1 className="font-headline text-4xl font-bold sm:text-6xl">Capi</h1>
          <img src={capitechLogo} alt="logo capitech" className="w-16 sm:w-24" />
          <h1 className="font-headline text-4xl font-bold sm:text-6xl">Tech</h1>
        </div>
